    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('label', models.CharField(help_text='The display name on the web site.', max_length=255, verbose_name='label')),
                ('slug', models.SlugField(help_text='Unique identifier for this menu item (also CSS ID)', unique=True, max_length=255, verbose_name='slug')),
                ...
                ('link', models.CharField(help_text='The view of the page you want to link to, as a python path or the shortened URL name.', max_length=255, verbose_name='link', blank=True)),
                ...
                ('parent', mptt.fields.TreeForeignKey(related_name='children', verbose_name='Parent', blank=True, to='treenav.MenuItem', null=True)),
            ],
            options={
